    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            <form wire:submit.prevent="trackTicket" class="flex flex-col md:flex-row gap-4">
                ...
                <button type="submit" class="bg-secondary text-white px-8 py-3 rounded-xl font-bold hover:bg-orange-600 transition shadow-lg shadow-secondary/30 flex items-center justify-center gap-2">
