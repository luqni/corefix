...
<body class="font-sans text-gray-900 antialiased bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-green-600">CoreFix</span>
                </div>
    ...
    <a href="https://wa.me/6281234567890" class="fixed bottom-6 right-6 md:hidden z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition shadow-green-500/30">
