...
<body class="font-sans antialiased bg-gray-100 flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    <div x-show="sidebarOpen" style="display: none;" class="fixed inset-0 z-40 md:hidden" role="dialog" aria-modal="true">
        ...
        <div x-show="sidebarOpen"
            ...
            <nav class="mt-5 flex-1 px-2 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.users') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-white hover:bg-gray-800 {{ request()->routeIs('admin.users*') ? 'bg-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mr-3 text-gray-300 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.transactions') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-white hover:bg-gray-800 {{ request()->routeIs('admin.transactions*') ? 'bg-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mr-3 text-gray-300 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.landing-page') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-white hover:bg-gray-800 {{ request()->routeIs('admin.landing-page') ? 'bg-indigo-600' : '' }}">
                    <svg class="w-6 h-6 mr-3 text-gray-300 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <aside class="w-64 bg-gray-900 text-white hidden md:flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            @if(auth()->user()->isSuperAdmin())
            <a href="{{ route('admin.users') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-md transition {{ request()->routeIs('admin.users*') ? 'bg-indigo-600 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                Kelola Pengguna
            ...
            <a href="{{ route('admin.transactions') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-md transition {{ request()->routeIs('admin.transactions*') ? 'bg-indigo-600 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                Keuangan Kas
            ...
            <a href="{{ route('admin.landing-page') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-md transition {{ request()->routeIs('admin.landing-page') ? 'bg-indigo-600 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
                Pengaturan Landing Page
    ...
    <style>
        @media print {
            ...
            #printableQrLabel, #printableQrLabel * {
