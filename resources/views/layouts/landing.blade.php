                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-500">
                        <li class="flex flex-col md:flex-row items-center md:items-start">
                             ...
                             <span class="text-center md:text-left">{{ $cms['footer_address'] ?? 'Toko Perumahan Taman Sari (Paling Utara), Jl. Sri Agung, Debong Kidul, Botomulyo, Kec. Cepiring, Kabupaten Kendal, Jawa Tengah 51352' }}</span>
                        </li>
                        <li class="flex flex-col md:flex-row items-center md:items-start mt-3">
                             ...
                             {{ $cms['footer_telephone'] ?? '089509045088' }}
                        </li>
                    </ul>
                </div>
            </div>
